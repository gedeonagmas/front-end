...
const Cha = ({ currentUser }) => {
  ...
  return (
    <div className="">
      {chatPage && (
        <div className="absolute left-[5%] flex place-items-center top-[60px]">
          <Back
            fontSize="small"
          ...
          <div className="h-[550px] w-[70vh] mt-1 flex flex-col place-items-center">
                  ...
                  <div className="flex flex-col my-2 text-gray-500">
                    {ownGroupList && (
                      <div className="flex flex-col items-center justify-center">
                        <p className="text-sm my-1 text-gray-600 underline font-semibold">
                          change your group profile picture
                        </p>
                        <img
                          src={require(`./../../../../iotUploads/${currentGroup.groupPro[0].path}`)}
                          alt="jdjdj"
                          className="h-20 w-[250px] rounded-sm mt-1"
                        />
                        <input
            ...
            <div className="bg-white border border-gray-200 flex gap-x-2 absolute bottom-1 w-[45%]">
              {!wellCome && (
                <Folder
              ...
              <input
                ...
                type="text"
                className="h-9  text-xs focus:outline-none w-[62vh] px-2 "
              ...
              {!wellCome && (
                <button
                  ...
                  className="bg-emerald-400  h-7 mx-[5px] my-[4px] text-white px-[13px] hover:bg-emerald-500"
                >
                  Send
                </button>
              )}
